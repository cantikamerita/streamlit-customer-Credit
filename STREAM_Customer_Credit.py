...
file_path = 'credit_customers.sav'  # Jika file berada di direktori yang sama dengan skrip
...
if st.button('Test Prediksi Customer Credit'):
    try:
        prediction = Customer_Credit_model.predict([[checking_status, duration, credit_history, credit_amount, savings_status, employment, installment_commitment, personal_status, other_parties, residence_since, age, housing, existing_credits, job, num_dependents, own_telephone]])
        if prediction[0] == 1:
